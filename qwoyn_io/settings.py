...
SHOP_PER_PAGE_CATEGORY = 25
SHOP_USE_PRODUCT_TYPE = False
SHOP_PRODUCT_SORT_OPTIONS = (
        ('Recently added', '-date_added'),
        ('Highest rated', '-rating_average'),
...
SITE_ID = 1
SITE_TITLE = "Qwoyn.io"
SITE_TAGLINE = "dAppCaps | Dan Gives Mediocre Handjobs To Starving Kids In Africa"
...
DEFAULT_FROM_EMAIL = 'support@qwoyn.io'
EMAIL_HOST_USER = ''
EMAIL_USE_TLS = False
EMAIL_HOST = ''
EMAIL_HOST_PASSWORD = ''
...
#http://mezzanine.jupo.org/docs/configuration.html#forms-disable-send-from-email-field
FORMS_DISABLE_SEND_FROM_EMAIL_FIELD = False
...
LOCALE_PATHS = (PROJECT_ROOT + THEME_URL + '/locale/', )
...
MEDIA_URL = STATIC_URL + "media/" ## Edited to include THEME_URL

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/home/media/media.lawrence.com/media/"
MEDIA_ROOT = os.path.join(PROJECT_ROOT, THEME_URL, *MEDIA_URL.strip("/").split("/"))
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(PROJECT_ROOT, THEME_URL, "templates")
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                #"wild1.context_processors.modal_content", ## Theme context processor
            ],
            "builtins": [
